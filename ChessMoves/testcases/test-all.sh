...
# with your ChessMoves.c file and all the test case files (source files and
# output files), and ChessMoves.h, and do the following:
#
...
do
	...
	# Attempt to compile.
	gcc ChessMoves.c testcase$i.c 2> /dev/null
	compile_val=$?
